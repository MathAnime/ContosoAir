[![Build Status](https://dev.azure.com/MathAnime/ContosoAir/_apis/build/status/MathAnime.ContosoAir?branchName=master)](https://dev.azure.com/MathAnime/ContosoAir/_build/latest?definitionId=1&branchName=master)
